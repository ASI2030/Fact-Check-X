...
<p align="center">
  <img src="assets/fact-check-x-overview.png?v=1.1.20" alt="Fact-Check-X multi-platform fact checking: complete capture, claim comparison, authoritative verification and answer generation, platform evaluation" width="900">
</p>
