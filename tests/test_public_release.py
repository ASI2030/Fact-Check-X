...
WORKBUDDY_VERSION = "1.1.8"
OFFICIAL_SHA = "b8b3075c22437847179970ee232fee7ee426c7454ec462a21a1f5bed36c402ac"
...
class PublicReleaseTest(unittest.TestCase):
    def test_public_tree_audit_passes(self):
        ...
        for readme in ("README.md", "README.en.md"):
            self.assertIn(
                "assets/fact-check-x-overview.png?v=1.1.8",
    ...
    def test_skillhub_package_is_market_clean_and_reproducible(self):
        with tempfile.TemporaryDirectory(prefix="fcx-skillhub-a-") as left_raw:
            with tempfile.TemporaryDirectory(prefix="fcx-skillhub-b-") as right_raw:
                ...
                self.assertIn(
                    "https://raw.githubusercontent.com/ASI2030/Fact-Check-X/main/assets/fact-check-x-overview.png?v=1.1.8",
                    skill,
                )
                for platform in (
                    "深知晓（深度溯源）",
