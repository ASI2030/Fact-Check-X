...
SCENARIOS = {
    ...
    "GR-019": ["node", "modules/llm-answer-reference-compare/tests/dknow_deep_research_placeholder_test.mjs"],
}
NODE_RUNTIME_CASES = {"GR-003", "GR-004", "GR-008", "GR-013", "GR-014", "GR-016", "GR-018", "GR-019"}
